...
class StoreAddForm(forms.Form):
    ...
    sun_closed = forms.BooleanField(required=False, initial=False)
    ...
    mon_closed = forms.BooleanField(required=False, initial=False)
    ...
    tues_closed = forms.BooleanField(required=False, initial=False)
    ...
    wed_closed = forms.BooleanField(required=False, initial=False)
    ...
    thur_closed = forms.BooleanField(required=False, initial=False)
    ...
    fri_closed = forms.BooleanField(required=False, initial=False)
    ...
    sat_closed = forms.BooleanField(required=False, initial=False)
