...
class UtilTest(TestCase):
	...
	def testJsonResponse(self):
		...
		self.assertEquals("application/json", response.content_type, "Issue with json_response util content type")
	...
	# 	self.assertEquals(expected, ElocalUtils.parseStore(testStore))
